...
var datasetsResource = schema.GroupVersionResource{Group: "datastore.io", Version: "v1alpha1", Resource: "datasets"}

var datasetsKind = schema.GroupVersionKind{Group: "datastore.io", Version: "v1alpha1", Kind: "DataSet"}
